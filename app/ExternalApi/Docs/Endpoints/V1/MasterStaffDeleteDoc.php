...
class MasterStaffDeleteDoc extends ApiEndpointDoc
{
    ...
    {
        return [
            ['code' => 'NOT_FOUND', 'http_status' => 404, 'message' => 'staff_id (rujukan Anda) tidak ditemukan, atau ditemukan tapi bukan staf yang dikelola endpoint ini (staf itu punya role, atau sudah dihapus sebelumnya).'],
        ];
    }
    ...
    public function notes(): array
    {
        return [
            ...
            'Endpoint ini HANYA boleh menghapus staf yang role_id-nya NULL (dan masih aktif) — staff_id yang menunjuk staf berperan apa pun dijawab NOT_FOUND.',
