...
class ShipmentCancelDoc extends ApiEndpointDoc
{
    ...
    {
        return [
            'Kalau shipment sebelumnya sudah ipm_status "Berjalan" (Confirmed, stok sudah dipotong lewat App\\Support\\SalesOrderApproval::confirm() — baik lewat POST /shipments/shipped maupun ACC manual di halaman admin), stok DIKEMBALIKAN dulu (App\\Support\\SalesOrderCancellation::cancel()) sebelum status berubah — message-nya menyebutkan itu secara eksplisit ("...dan stok telah dikembalikan."). Kalau belum pernah "Berjalan" (mis. masih "Dijadwalkan"/"Belum terkirim"/"Sudah terkirim"), tidak ada stok yang perlu dikembalikan — message-nya cuma "Dokumen berhasil dibatalkan." tanpa menyebut stok.',
