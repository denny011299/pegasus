...
class ShipmentShippedDoc extends ApiEndpointDoc
{
    ...
    public function notes(): array
    {
        return [
            ...
            'warehouse_id pada tiap sales_order_details maupun perhitungan stok selalu gudang utama (ProductStock::resolveWarehouseId(null)) — endpoint ini tidak menerima parameter gudang, sama seperti /shipments/scheduled.',
        ];
    }
}
