...
--
-- Membedakan produksi yang di-ACC/tolak lewat aksi staf sungguhan dari yang
-- di-auto-timeout oleh ProductionOverdueAutoResolver.
...
SET @sql := IF(
  ...
  'ALTER TABLE `productions`
     ADD COLUMN `resolved_by_system` TINYINT(1) NOT NULL DEFAULT 0 AFTER `acc_by`',
