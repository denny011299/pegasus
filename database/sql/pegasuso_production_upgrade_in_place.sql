...
FROM (
  SELECT '2026_07_22_013000_create_warehouse_types_table' AS `migration`
  UNION ALL
  SELECT '2026_07_22_013100_create_warehouses_table' AS `migration`
  UNION ALL
  SELECT '2026_07_22_120000_make_warehouse_address_nullable' AS `migration`
  UNION ALL
  SELECT '2026_07_22_121000_create_staff_warehouses_table' AS `migration`
  UNION ALL
  SELECT '2026_07_22_122200_add_last_active_warehouse_id_to_staffs_table' AS `migration`
  UNION ALL
  SELECT '2026_07_23_100000_add_is_main_warehouse_to_warehouse_types_table' AS `migration`
  UNION ALL
  SELECT '2026_07_23_190000_add_warehouse_id_to_product_stocks_table' AS `migration`
  UNION ALL
  SELECT '2026_07_24_150000_add_warehouse_id_to_supplies_stocks_table' AS `migration`
  UNION ALL
  SELECT '2026_07_24_170000_add_sidebar_menus_to_warehouses_table' AS `migration`
  UNION ALL
  SELECT '2026_07_27_000100_add_warehouse_id_to_log_stocks_table' AS `migration`
  UNION ALL
  SELECT '2026_07_27_002805_add_retail_warehouse_id_to_sales_orders_table' AS `migration`
  UNION ALL
  SELECT '2026_07_29_140000_add_warehouse_id_to_sales_order_details_table' AS `migration`
  UNION ALL
  SELECT '2026_08_15_154000_add_is_kepala_cabang_to_staff_warehouses_table' AS `migration`
  UNION ALL
  SELECT '2026_08_20_180000_add_warehouse_id_to_stock_opnames_tables' AS `migration`
) m
WHERE NOT EXISTS (
