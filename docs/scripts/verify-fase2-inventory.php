...
$requiredFiles = [
    ...
    'app/Http/Controllers/CustomerReturnController.php',
    ...
    'resources/views/components/modals/production/fix-recipe-bom.blade.php',
    'resources/views/components/modals/customer-return/add-customer-return.blade.php',
...
$markers = [
    ...
    ['public/assets/json/permission.json', '"SubModules": "Gudang"'],
    ['public/assets/json/permission.json', '"SubModules": "Tipe Gudang"'],
    ['tests/Workflow/StockTransferWorkflowTest.php', 'test_ship_unpacks_ancestor_when_sent_unit_stock_is_short'],
    ['tests/Workflow/StockTransferWorkflowTest.php', 'test_ship_refuses_when_ancestor_equivalent_still_short'],
