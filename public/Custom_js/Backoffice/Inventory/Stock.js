    ...
    $(document).on('click','.btnAdd',function(){
        mode=1;
        $('#add_stock .modal-title').html("Create Stock");
        $('#add_stock input').val("");
    ...
    $(document).on("click",".btn-save",function(){
       // LoadingButton(this);
        ...
        if(mode==2){
            url="/updateProduct";
            // param.category_id = $('#add_stock').attr("category_id");
        }
    ...
    $(document).on("click",".btn_edit",function(){
        var data = $('#tableStock').DataTable().row($(this).parents('tr')).data();//ambil data dari table
        mode=2;
        $('#add_stock .modal-title').html("Update Product");
        $('#add_stock input').empty().val("");
        // $('#category_name').val(data.category_name);

        $('#add_stock').modal("show");
        // $('#add_stock').attr("category_id", data.category_id);
    });
