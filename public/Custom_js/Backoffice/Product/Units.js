    ...
    function inisialisasi() {
        table = $('#tableUnits').DataTable({
            ...
            columns: [
                ...
                { data: "created_by_name", defaultContent: "-", width: "24%" , render: function(data, type, row) { return typeof renderCreatedBySync === "function" ? renderCreatedBySync(data, row) : data; } },
            ...
            success: function (e) {
                ...
                for (let i = 0; i < e.length; i++) {
                    ...
                    var ue =
                        roleIconEdit(
                            "Satuan",
                            "btn-action-icon me-2 p-2 btn_edit",
                            'data-id="' +
                                e[i].unit_id +
                        ...
                        roleIconDelete(
                            "Satuan",
                            "btn-action-icon p-2 btn_delete",
                            'data-id="' +
                                e[i].unit_id +
