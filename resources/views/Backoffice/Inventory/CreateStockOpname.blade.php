...
@section('content')
  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div id="collapseHeaderOpname" class="collapse show">
          <div class="card-body p-4">
            <div class="row g-3">
              ...
              {{-- Fitur "Clean Up Data" (2026-09-04): cuma dipilih SEKALI saat dokumen dibuat, dan
                   cuma ditampilkan kalau staf berizin ("Stok Opname - Bersihkan Data"|create) DAN
                   gudang aktif memang gudang utama -- di luar itu jenisnya diam-diam 1 (opname
                   biasa) lewat hidden input, backend menegakkan hal yang sama sebagai jaring kedua. --}}
              ...
              @else
                <input type="hidden" id="jenis_opname" value="{{ ($mode ?? 1) == 2 ? (int) (($data['sto_type'] ?? 1)) : 1 }}">
              @endif
              <div class="col-lg-3 col-md-6 col-12">
      ...
      {{-- Fitur "Clean Up Data" (2026-09-04): tidak ada hitungan manual sama sekali untuk jenis
           ini -- tabel produk diganti penjelasan tindakan ini, ditoggle lewat #jenis_opname di
           CreateStockOpname.js (setCleanUpMode()). --}}
          ...
          <div class="d-flex align-items-start gap-3">
            ...
            <div>
              ...
              <p class="mb-0 text-muted" style="font-size:13px;line-height:1.6;">
                Tidak perlu menghitung stok secara manual. Saat disetujui, sistem akan menyusun ulang
                stok yang sudah ada di Gudang Utama ke satuan yang seharusnya (misal 1 DOS = 12 pcs)
                tanpa mengubah jumlah fisik barang sama sekali -- cuma representasinya di antar satuan
                yang diperbaiki.
              </p>
            </div>
          </div>
          ...
          <div class="stock-opname-toolbar d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
            ...
            <div class="d-none d-md-flex align-items-center gap-2 flex-wrap stock-opname-actions-desktop">
              ...
              @if (
                  ...
                  \App\Support\RoleAccess::can(Session::get('user'), 'Stok Opname - Bersihkan Data', 'others'))
...
@section('custom_js')
  <script>
    ...
    // Fitur "Clean Up Data" (2026-09-04): tombol Terima/Tolak dirender statis di server (lihat
    // blok kondisi di atas) untuk PEMILIK salah satu izin -- flag ini dipakai JS supaya
    // per-dokumen (data.sto_type) tetap menuntut izin yang BENAR sebelum menampilkan tombol.
    var canOthersNormal = @json(\App\Support\RoleAccess::can(Session::get('user'), 'Stok Opname Produk', 'others'));
