...
@section('custom_js')
    ...
    <script src="{{ asset('Custom_js/Backoffice/Inventory/Stock_Opname.js') }}?v=3"></script>
    <script>
        if (window.OpnamePageLockUi) {
            window.OpnamePageLockUi.showFlashErrorIfAny();
            window.OpnamePageLockUi.bindListTambahPrecheck("product", ".btn-opname-tambah-produk");
        }
    </script>
@endsection
