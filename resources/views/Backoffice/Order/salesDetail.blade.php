    ...
    <div class="page-wrapper">
        <div class="content">
            @component('components.breadcrumb')
                ...
                @endslot
                @slot('li_1')
                    <span id="so_code">Sales Order:</span>
                @endslot
            @endcomponent
                                    ...
                                    <div class="accordion-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="input-blocks">
                                                    <div class="border rounded p-3">
                                                        ...
                                                        <div class="mb-2">
                                                            <strong>Nama Pengirim:</strong> abc
                                                        </div>
                                                        <div class="mb-2">
                                                            <strong>Alamat:</strong> bcd
                                                        </div>
                                                        <div class="mb-0">
                                                            <strong>No Tlp:</strong> 0812345678
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="input-blocks">
                                                    <div class="border rounded p-3">
                                                        <h4 class="mb-3">Detail Customer</h4>
                                                        <div class="mb-2">
                                                            <strong>Nama: </strong><span id="nama_penerima"></span>
                                                        </div>
                                                        <div class="mb-2">
                                                            <strong>Alamat: </strong><span id="alamat_penerima"></span>
                                                        </div>
                                                        <div class="mb-0">
                                                            <strong>No Tlp: </strong><span id="no_tlp_penerima"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header" id="headingTwo">
                                    <div class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
                                        ...
                                        <div class="text-editor add-list">
                                            <div class="addproduct-icon list icon">
                                                <h5><i data-feather="life-buoy" class="add-info"></i><span> Delivery
                                                        Notes</span>
                                                </h5>
                                                <a href="javascript:void(0);"><i data-feather="chevron-down"
                                                        class="chevron-down-add"></i></a>
                                            ...
                                            <div class="page-btn ms-auto">
                                                <a href="#" class="btn btn-added" data-bs-toggle="modal"
                                                    id="btn-add-delivery" data-bs-target="#add-delivery-note"><i
                                                        data-feather="plus-circle" class="me-2"></i>Buat Delivery Notes
                                                    Baru</a>
                                            </div>
                                        </div>
...
@section('custom_js')
    ...
    <script src="{{ asset('/Custom_js/Backoffice/Order/SalesDetail.js') }}?v={{ time() }}"></script>
@endsection
