...
<body>
    <div class="container">
        ...
        <table class="info-table">
            <tr>
                <td style="width: 60%;">
                    ...
                    <p style="margin: 0;"><span class="label">Nama Pembeli</span>:
                        {{ $delivery_so['customer_nama'] ?? '-' }}</p>
                    <p style="margin: 0;"><span class="label">Nama Penerima</span>:
                        {{ $delivery_so['nama_penerima'] ?? '-' }}</p>
                    <p style="margin: 0;"><span class="label">Alamat</span>: {{ $delivery_so['alamat'] ?? '-' }}</p>
                </td>
                <td style="width: 40%;padding-top: 10px;">
                    <p style="margin: 0;"><span class="label">No. Invoice</span>: {{ $delivery_so['so_kode'] ?? '-' }}
                    </p>
        ...
        <table class="item-table">
            <thead>
                <tr>
                    ...
                    <th class="nama-varian-col">Nama Varian</th>
            ...
            <tbody>
                @foreach ($delivery_so_detail as $item)
                    <tr>
                        ...
                        <td class="qty-col">{{ $item['jumlah'] ?? 0 }}</td>
                        <td>{{ $item['SKU'] ?? '-' }}</td>
                        <td>
        ...
        <div class="signature-section">
            <div class="signature-text">BARANG SUDAH DITERIMA DALAM KEADAAN BAIK DAN CUKUP oleh:<br>(tanda tangan dan
                cap (stempel) perusahaan)</div>
            <table class="signature-roles-table">
                <tr>
                    <td>
                        <div class="signature-line"></div>
                        <div class="signature-label">Penerima / Pembeli</div>
                    </td>
                    <td>
                        <div class="signature-line"></div>
                        <div class="signature-label">Bagian Pengiriman</div>
                    </td>
                    <td>
                        <div class="signature-line"></div>
