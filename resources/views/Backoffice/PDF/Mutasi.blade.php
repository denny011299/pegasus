...
<body>
    <div class="container">
        <table class="header-table">
            <tr>
                ...
                <td class="header-title">
                    <h1>SURAT MUTASI STOCK</h1>
                    <h5><i>Stock Transfer</i></h5>
                </td>
            </tr>
        </table>
        ...
        <table class="info-table">
            <tr>
                <td style="width: 60%;">
                    <p style="margin: 0;"><span class="label">Tanggal</span>: {{ $tanggal ?? '-' }}</p>
                    <p style="margin: 0;"><span class="label">Pengirim</span>:
                        {{ $nama_pengirim ?? '-' }}</p>
                    <p style="margin: 0;"><span class="label">Asal</span>:
                        {{ $nama_asal ?? '-' }}</p>
                </td>
                <td style="width: 40%;padding-top: 10px;">
                    <p style="margin: 0;"><span class="label">Kode Ref</span>:
                        {{ $kode ?? '-' }}</p>
                    <p style="margin: 0;"><span class="label">Penerima</span>:
                        {{ $nama_penerima ?? '-' }}</p>
                    <p style="margin: 0;"><span class="label">Tujuan</span>:
                        {{ $nama_tujuan ?? '-' }}</p>
                </td>
            </tr>
        </table>
                    ...
                    <td>
                        @if (is_numeric($item['harga'] ?? null) && is_numeric($item['jumlah'] ?? null))
                            @php
                                ...
                                $totalSubtotal = collect($detail)->sum(function ($item) {
