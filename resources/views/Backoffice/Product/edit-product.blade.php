    ...
    <div class="page-wrapper">
        <div class="content">
            @component('components.breadcrumb')
                @slot('title')
                    <div class="title-produk">Edit Produk</div>
                @endslot
                @slot('li_1')
                    <div class="subtitle-produk">Ubah Detail Produk</div>
                @endslot
            @endcomponent
            <form action="edit-product">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4 col-sm-6 col-12">
                                                <div class="mb-3 add-product">
                                                    ...
                                                    <input type="text" class="form-control fill" id="nama_produk"
                                                        name="nama_produk">
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-sm-6 col-12">
                                                <div class="mb-3 add-product">
                                                    ...
                                                    <select class="select fill" id="kategori" name="kategori">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-sm-6 col-12">
                                                <div class="mb-3 add-product">
                                                    ...
                                                    <select class="select fill" id="merek" name="merek">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-sm-6 col-12">
                                                <div class="mb-3 add-product">
                                                    ...
                                                    <select class="select field-satuan" id="satuan" name="satuan[]"
                                                        multiple>
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <ul class="nav nav-pills" id="pills-tab1" role="tablist">
                                                    <li class="nav-item" role="presentation">
                                                        <span class="custom_radio me-4 mb-0 active" id="pills-home-tab"
                                                            ...
                                                            <input type="radio" class="form-control" name="tipe"
                                                                value="tunggal">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="input-blocks add-product">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control field-harga nominal_only"
                                                    ...
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="input-blocks add-product list">
                                                            <label>SKU</label>
                                                            <input type="text" class="form-control list field-sku"
                                                                id="sku_single">
                                                    ...
                                                    <div class="col-lg-4 col-sm-6 col-8">
                                                        <div class="input-blocks add-product list">
                                                            ...
                                                            <input type="text"
                                                                class="form-control list field-barcode number-only"
                                                                id="barcode_single">
                                                            <button type="submit" class="btn btn-primaryadd"
                                                                        ...
                                                                        <div class="col-lg-4 col-sm-4 col-12"
                                                                            ...
                                                                            <div class="input-blocks add-product">
                                                                                ...
                                                                                <input type="text" id="garansi"
                                                                                    class="form-control number-only field-garansi"
                                                                            ...
                                                                            <div class="input-blocks add-product">
                                                                                ...
                                                                                <div class="d-flex align-items-center row">
                                                                                    <div class="col-4"> <input
                                                                                            type="number"
                                                                                            class="form-control field-peringatan-kuantitas number-only"
                                                                                            id="peringatan_kuantitas">
                                                                                    </div>
                                                                                    <div class="col-6">
                                                                                        <select
                                                                                            class="form-control select field-peringatan-satuan"
                ...
                <div class="col-lg-12">
                    <div class="btn-addproduct mb-4">
                        ...
                        {{-- <button type="button" class="btn btn-cancel me-2" id="checkvalue">Check</button> --}}
...
@section('custom_js')
    ...
    <script src="{{ asset('/Custom_js/Backoffice/Product/EditProduct.js') }}?v={{ time() }}"></script>
@endsection
