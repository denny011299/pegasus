...
@section('custom_css')
<style>
    #warehouse-table-wrap.dt-pending #tableWarehouse,
    #warehouse-table-wrap.dt-pending #tableWarehouse_wrapper {
        display: none !important;
    }
    #warehouse-table-wrap.dt-ready .dt-skeleton {
        display: none !important;
    }
    ...
    #tableWarehouse td:last-child,
    #tableWarehouse th:last-child {
        white-space: nowrap !important;
        width: 1%;
    }
    #tableWarehouse td:last-child a {
                ...
                <div class="card-table">
                    <div class="card-body">
                        <div class="table-responsive dt-pending" id="warehouse-table-wrap">
                            ...
                            <table class="table table-hover" id="tableWarehouse">
                                <thead>
                                    <tr>
...
@section('custom_js')
<script src="{{ asset('Custom_js/Backoffice/Warehouse/Warehouse.js') }}"></script>
@endsection
