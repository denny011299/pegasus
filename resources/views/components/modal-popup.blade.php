...
@if (Route::is(['production']))
  <div class="modal custom-modal fade" id="addProduction" aria-modal="true" role="dialog" tabindex="-1"
          ...
          <div class="modal-footer border-top justify-content-end" style="background:#f8fafc;padding:14px 24px;">
            <div class="d-flex gap-2 me-auto">
              @if (in_array('others', $akses->firstWhere('name', 'Produksi')->akses))
                <button type="button" id="btn-tolak" class="btn d-none btn_decline"
                  style="background:#fef2f2;color:#ef4444;border:1px solid #fecaca;border-radius:8px;padding:9px 20px;font-size:13px;font-weight:600;"><i
                    class="fe fe-x me-1"></i>Tolak</button>
                <button type="button" id="btn-terima" class="btn d-none btn_acc"
                  style="background:linear-gradient(135deg,#10b981,#059669);color:#fff;border:none;border-radius:8px;padding:9px 24px;font-size:13px;font-weight:600;box-shadow:0 4px 12px rgba(16,185,129,.3);"><i
                    class="fe fe-check me-1"></i>Terima</button>
              @endif
            </div>
            <div class="d-flex gap-2">
              <button type="button" data-bs-dismiss="modal" class="btn btn-cancel"
                style="border:1px solid #e2e8f0;background:#f1f5f9;border-radius:8px;padding:9px 20px;font-size:13px;font-weight:600;color:#64748b;">Batal</button>
              <button type="button"
              ...
              <div class="row">
                ...
                <div class="col-6 col-lg-4">
                  <div class="input-block mb-3">
                    ...
                    <input type="number" class="form-control number-only" id="lead_time_days" value="0"
                      min="0" step="1">
                  </div>
                </div>
                <div class="col-6 col-lg-4">
                  <div class="input-block mb-3">
                    ...
                    <input type="number" class="form-control number-only" id="safety_stock" value="0"
                      min="0" step="1">
                  </div>
                </div>
                <div class="col-12">
