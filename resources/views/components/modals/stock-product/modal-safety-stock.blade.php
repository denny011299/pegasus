    ...
    <div class="modal-dialog modal-dialog-centered modal-md">
      <div class="modal-content" style="border-radius: 16px; overflow: hidden; border: none;">
        ...
        <div class="modal-body p-0" style="background:#f8fafc;">
          ...
          {{-- Section 2: Transfer ke Stok Produk (hidden — restore by removing d-none) --}}
          <div class="st-safety-transfer-section d-none">
        ...
        {{-- ── FOOTER ── --}}
        <div class="modal-footer pg-modal-footer justify-content-end gap-2">
          <button type="button" class="btn pg-btn-cancel cancel-btn" data-bs-dismiss="modal">Batal</button>
          <button type="button"
            class="btn btn-save d-inline-flex align-items-center justify-content-center gap-2"
            id="btn_save_safety"
            style="background:linear-gradient(135deg,#3b82f6,#2563eb);color:#fff;border:none;border-radius:8px;padding:9px 22px;font-size:13px;font-weight:600;min-width:140px;height:42px;box-shadow:0 4px 12px rgba(59,130,246,.3);">
