<div class="modal fade custom-modal pg-modal--form" id="add_stock_supplies" data-bs-backdrop="static"
      ...
      <div class="modal-content d-flex flex-column" style="border-radius: 16px; overflow: hidden; border: none; max-height: 92vh;">
        ...
        <div class="modal-header">
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              <h5 class="mb-0 fw-bold modal-title">Riwayat Stok Bahan Mentah</h5>
              <small class="text-muted modal-subtitle">Detail mutasi dan penyesuaian stok bahan</small>
            </div>
          </div>
