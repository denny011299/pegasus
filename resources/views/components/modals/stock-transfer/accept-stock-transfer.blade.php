      ...
      <form action="#" id="formAcceptStockTransfer" class="modal-content d-flex flex-column"
        ...
        <div class="border-bottom p-3 p-md-4" style="background:#ffffff;">
          <div class="row g-3 align-items-stretch">
              ...
              <div class="p-3 rounded-3 border h-100" style="background:#f8fafc; border-color:#e2e8f0;">
                ...
                <div class="row g-2 mt-0">
                  <div class="col-6">
                    ...
                    <div class="fw-bold text-dark mt-0.5" style="font-size:12.5px;word-break:break-word;" id="lbl_accept_from">-</div>
                  </div>
                  <div class="col-6">
                    <div class="text-muted"
                      style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.3px;color:#475569;"><i
                        class="fe fe-user me-1 text-primary"></i>Pengirim</div>
                    <div class="fw-bold text-dark mt-0.5" style="font-size:12.5px;word-break:break-word;" id="lbl_accept_sender">-</div>
                  </div>
            ...
            {{-- Arrow: di mobile panah ke bawah, di desktop panah ke kanan --}}
            <div class="col-12 col-md-2 d-flex align-items-center justify-content-center my-2 my-md-0 pt-0 pt-md-4">
              <div class="d-flex flex-row flex-md-column align-items-center gap-2 gap-md-1">
                <div
                  style="width:32px;height:32px;background:linear-gradient(135deg,#059669,#10b981);border-radius:50%;display:flex;align-items:center;justify-content:center;color:#fff;box-shadow:0 2px 6px rgba(5,150,105,.25);">
              ...
              <div class="p-3 rounded-3 border h-100" style="background:#f8fafc; border-color:#e2e8f0;">
                ...
                <div class="row g-2 mt-0 flex-grow-1">
                  <div class="col-6">
                    ...
                    <div class="fw-bold text-dark mt-0.5" style="font-size:12.5px;word-break:break-word;" id="lbl_accept_to">-</div>
                  </div>
                  <div class="col-6">
                    <div class="text-muted"
                      style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:.3px;color:#475569;"><i
