<div class="tab-pane active" id="invoice_tab" role="tabpanel" aria-labelledby="invoice-tab"
tabindex="0">
        ...
        <div class="row">
                ...
                <div
                    ...
                    <div class="blog-image">
                        <a href="javascript:;" class="img-general"><img class="img-fluid"
                                src="{{ URL::asset('/assets/img/invoice-one.svg') }}"
                                alt="Post Image">
                        </a>
                        <a href="{{ URL::asset('/assets/img/invoice-one.jpg') }}"
            ...
            <div class="col-md-6 col-xl-3 col-sm-12 d-md-flex d-sm-block">
                <div
                    ...
                    <div class="blog-image">
                        <a href="javascript:;" class="img-general"><img class="img-fluid"
                                src="{{ URL::asset('/assets/img/invoice - two.svg') }}"
                                alt="Post Image">
                        </a>
                        <a href="{{ URL::asset('/assets/img/invoice-two.jpg') }}"
                            class="preview-invoice image-popup"><i
                                class="fa-regular fa-eye"></i></a>
                    </div>
                    <div class="invoice-content-title">
            ...
            <div class="col-md-6 col-xl-3 col-sm-12 d-md-flex d-sm-block">
                <div
                    ...
                    <div class="blog-image">
                        <a href="javascript:;" class="img-general"><img class="img-fluid"
                                src="{{ URL::asset('/assets/img/invoice - three.svg') }}"
                                alt="Post Image">
                        </a>
                        <a href="{{ URL::asset('/assets/img/invoice-three.jpg') }}"
                            class="preview-invoice image-popup"><i
                                class="fa-regular fa-eye"></i></a>
                    </div>
                    <div class="invoice-content-title">
            ...
            <div class="col-md-6 col-xl-3 col-sm-12 d-md-flex d-sm-block">
                <div
                    ...
                    <div class="blog-image">
                        <a href="javascript:;" class="img-general"><img class="img-fluid"
                                src="{{ URL::asset('/assets/img/invoice-four.svg') }}"
                                alt="Post Image">
                        </a>
                        <a href="{{ URL::asset('/assets/img/invoice-four.jpg') }}"
                            class="preview-invoice image-popup"><i
                                class="fa-regular fa-eye"></i></a>
                    </div>
                    <div class="invoice-content-title">
            ...
            <div class="col-md-6 col-xl-3 col-sm-12 d-md-flex d-sm-block">
                <div
                    ...
                    <div class="blog-image">
                        <a href="javascript:;" class="img-general"><img class="img-fluid"
                                src="{{ URL::asset('/assets/img/invoice - five.svg') }}"
                                alt="Post Image">
                        </a>
                        <a href="{{ URL::asset('/assets/img/invoice - five.svg') }}"
                            class="preview-invoice image-popup"><i
                                class="fa-regular fa-eye"></i></a>
                    </div>
                    <div class="invoice-content-title">
